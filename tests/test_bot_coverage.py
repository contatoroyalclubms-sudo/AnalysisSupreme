...
class TestBotCoverage:
    ...
    def mock_motor_ia(self):
        motor = Mock()
        motor.analisar_mercado = AsyncMock(return_value={
            'sinal': 'comprar',
            'confidence': 0.8,
            'preco_entrada': 50000
        })
    ...
    async def test_momentum_comprehensive(self, mock_config, mock_monitor, mock_motor_ia):
        ...
        for i in range(50):
            ...
            ohlcv_data.append([
                ...
                price, price + 100, price - 50, price + 50, 1000
            ])
    ...
    async def test_swing_comprehensive(self, mock_config, mock_monitor, mock_motor_ia):
        ...
        for i in range(100):
            price = 50000 + (i * 5)
            ohlcv_data.append([
                1640995200000 + i*3600000,  # Hourly data
                price, price + 200, price - 100, price + 100, 1000
            ])
