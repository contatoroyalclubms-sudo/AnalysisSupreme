...
class TestCalculadorMetricas:
    ...
    def test_calcular_metricas_simples(self):
        ...
        trades = [
            Trade(
                id="1", bot="arbitragem", symbol="BTC/USDT", side="buy", amount=0.01, 
                price=50000, timestamp=datetime.now(), caso_uso=1, pnl=100
            ),
            Trade(
                id="2", bot="arbitragem", symbol="BTC/USDT", side="sell", amount=0.01, 
                price=49000, timestamp=datetime.now(), caso_uso=1, pnl=-50
            ),
            Trade(
                id="3", bot="arbitragem", symbol="BTC/USDT", side="buy", amount=0.01, 
                price=51000, timestamp=datetime.now(), caso_uso=1, pnl=200
            )
        ]
    ...
    def test_calcular_sharpe_ratio(self):
        ...
        trades = [
            Trade(id="1", bot="grid", symbol="BTC/USDT", side="buy", amount=0.01, 
                  price=50000, timestamp=datetime.now(), caso_uso=1, pnl=100),
            Trade(id="2", bot="grid", symbol="BTC/USDT", side="sell", amount=0.01, 
                  price=49000, timestamp=datetime.now(), caso_uso=1, pnl=50)
        ]
    ...
    def test_calcular_drawdown(self):
        ...
        trades = [
            Trade(id="1", bot="momentum", symbol="BTC/USDT", side="buy", amount=0.01, 
                  price=50000, timestamp=datetime.now(), caso_uso=1, pnl=100),
            Trade(id="2", bot="momentum", symbol="BTC/USDT", side="sell", amount=0.01, 
                  price=49000, timestamp=datetime.now(), caso_uso=1, pnl=-150),
            Trade(id="3", bot="momentum", symbol="BTC/USDT", side="buy", amount=0.01, 
                  price=51000, timestamp=datetime.now(), caso_uso=1, pnl=50)
        ]
