...
def gerar_progresso_json():
    ...
    principais = [
        "Makefile", "setup.py", "requirements.txt",
        "src/utils/kpis.py", "scripts/auditoria.py",
    ...
    progresso = {
        ...
        "status": {
            ...
            "total_bots": 6,
            "scripts_criados": len([s for s in ["setup_caso.py", "executar.py", "validar.py", "relatorio_geral.py", "auditoria.py"] if os.path.exists(f"scripts/{s}")]),
