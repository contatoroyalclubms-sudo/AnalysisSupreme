...
def main():
    ...
    parser.add_argument("--bot", required=True, choices=["arbitragem", "grid", "momentum", "scalping", "mean_reversion", "swing"])
    parser.add_argument("--regime", required=True, choices=["alta_vol", "baixa_vol", "lateral", "breakout", "continuacao", "volume"])
