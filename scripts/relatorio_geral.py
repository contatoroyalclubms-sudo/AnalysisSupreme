...
def verificar_estrutura():
    ...
    diretorios_esperados = [
        "src/bots", "src/core", "src/exchange", "src/ia", 
        "src/observabilidade", "src/utils", "config", "logs", 
        "tests", "scripts"
    ]
...
def gerar_relatorio_final_json():
    ...
    try:
        ...
        relatorio = {
            ...
            "qualidade": {
                "pronto_producao": (
                    len(bots_implementados) == 6 and 
                    total_casos_uso >= 18 and 
                    all(funcionalidades.values())
                ),
            ...
            "casos_uso": {
                ...
                "regimes_suportados": [
                    "alta_vol", "baixa_vol", "lateral",
                    "breakout", "continuacao", "volume"
                ]
            }
        }
