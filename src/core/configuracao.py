    ...
    def _configuracao_padrao(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "bots": {
                ...
                "grid": {
                    "ativo": True,
                    "parametros": {"grid_size": 10, "grid_spacing": 0.01},
                    "casos_uso": {
                ...
                "momentum": {
                    "ativo": True,
                    "parametros": {"lookback_period": 20, "momentum_threshold": 0.02},
                    "casos_uso": {
                ...
                "scalping": {
                    "ativo": True,
                    "parametros": {"target_profit": 0.001, "max_hold_time": 300},
                    "casos_uso": {
                ...
                "mean_reversion": {
                    "ativo": True,
                    "parametros": {"lookback_period": 50, "deviation_threshold": 2.0},
                    "casos_uso": {
                ...
                "swing": {
                    "ativo": True,
                    "parametros": {"swing_period": 100, "min_swing_size": 0.05},
                    "casos_uso": {
