...
class BotMeanReversion(BotBase):
    ...
    async def _detectar_reversion_simples(self, symbol: str, media_type: str, 
    ...
    async def _detectar_bollinger_reversion(self, symbol: str, period: int, 
                                          std_dev: float) -> Optional[Dict]:
    ...
    async def _detectar_rsi_divergence(self, symbol: str, rsi_period: int) -> Optional[Dict]:
        ...
        try:
            ...
            if (preco_low_atual < preco_low_anterior and 
                rsi_low_atual > rsi_low_anterior and 
                rsi_low_atual < 40):
            ...
            if (preco_high_atual > preco_high_anterior and 
                rsi_high_atual < rsi_high_anterior and 
                rsi_high_atual > 60):
