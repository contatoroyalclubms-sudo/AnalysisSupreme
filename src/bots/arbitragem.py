...
class BotArbitragem(BotBase):
    ...
    async def _detectar_arbitragem_simples(self, symbol: str, exchange1: str, 
                                         exchange2: str, min_profit: float) -> Optional[Dict]:
    ...
    async def _detectar_arbitragem_triangular(self, pares: List[str], 
