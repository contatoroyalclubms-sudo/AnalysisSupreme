            ...
            children=[
                html.Div(
                    [
                        ...
                        html.Span(
                            "Sistema Online",
                            style={"font-weight": "600", "color": "#00d4aa"},
                        ),
                    ],
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.Div(
                                    "$0", id="total-profit", className="metric-value"
                                ),
                        ...
                        html.Div(
                            [
                                html.Div(
                                    "0", id="total-trades", className="metric-value"
                                ),
                        ...
                        html.Div(
                            [
                                html.Div(
                                    "0%", id="success-rate", className="metric-value"
                                ),
                        ...
                        html.Div(
                            [
                                html.Div(
                                    "0ms", id="avg-latency", className="metric-value"
                                ),
        ...
        html.Div(
            [
                html.H2(
                    ...
                    style={"color": "#2c3e50", "margin-top": "40px"},
                ),
                html.Div(
                    [
                        html.Div(
                            [
                                dcc.Graph(
                                    id="performance-chart", style={"height": "400px"}
                                )
                            ],
                        ...
                        html.Div(
                            [
                                dcc.Graph(
                                    id="portfolio-chart", style={"height": "400px"}
                                )
                            ],
                            style={"width": "50%", "display": "inline-block"},
                        ),
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                dcc.Graph(
                                    id="ai-metrics-chart", style={"height": "400px"}
                                )
                            ],
                            style={"width": "50%", "display": "inline-block"},
                        ),
                        html.Div(
                            [
                                dcc.Graph(
                                    id="risk-metrics-chart", style={"height": "400px"}
                                )
                            ],
                            style={"width": "50%", "display": "inline-block"},
                        ),
...
@callback(Output("dashboard-data", "data"), Input("interval-component", "n_intervals"))
...
def update_metric_cards(data):
    ...
    return (f"${profit:.2f}", f"{trades:,}", f"{success_rate:.1f}%", f"{latency:.1f}ms")


@callback(Output("performance-chart", "figure"), Input("dashboard-data", "data"))
...
@callback(Output("portfolio-chart", "figure"), Input("dashboard-data", "data"))
def update_portfolio_chart(data):
    ...
    fig = go.Figure(
        data=[go.Pie(labels=assets, values=values, hole=0.4, marker_colors=colors)]
    )

    fig.update_layout(
        title="Distribuição do Portfolio", template="plotly_white", height=400
    )

    return fig


@callback(Output("ai-metrics-chart", "figure"), Input("dashboard-data", "data"))
...
@callback(Output("risk-metrics-chart", "figure"), Input("dashboard-data", "data"))
def update_risk_metrics_chart(data):
    ...
    times = pd.date_range(
        start=datetime.now() - timedelta(hours=12), end=datetime.now(), freq="30min"
    )
...
@callback(Output("competitive-chart", "figure"), Input("dashboard-data", "data"))
...
def handle_bot_controls(start_clicks, pause_clicks, stop_clicks, restart_clicks):
    ...
    if button_id == "start-all-btn":
        ...
        return html.Div(
            "⏸️ Sistema pausado", style={"color": "#ffa500", "font-weight": "600"}
        )
...
if __name__ == "__main__":
    app.run(host="0.0.0.0", port=8050, debug=False)  # nosec B104
